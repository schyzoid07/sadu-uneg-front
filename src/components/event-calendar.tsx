                                ...
                                {dayEvents.map((event) => (
                                    <Dialog key={event.ID}>
                                        <DialogTrigger asChild>
                                            <div className="text-[10px] sm:text-xs px-1.5 py-1 rounded bg-blue-100 text-blue-700 truncate cursor-pointer hover:bg-blue-200 transition-colors" title={event.Name}>
                                                {event.Name}
                                            </div>
                                        </DialogTrigger>
                                        <DialogContent>
